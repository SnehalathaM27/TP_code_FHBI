...
public class Imp_2_Xpheno_TravelPolicyTestingForHeadGrade extends BaseClass{
	WebDriver driver;    
...
//        int hotelindex = Integer.parseInt(excelData.get("HotelIndex"));
		...
		String dmTlGrade = excelData.get("DmTlGrade");
...
NewDesign_Emulate_Process.waitUntilApproverScreenDisplay(Log, screenShots);
	        ...
	        //select grade ----------------------
	        String[] selectedGradeFromDropdown = Implementation_Corporate_Travellers_Page.clickOnSelectGrade(headGrade, Log);
