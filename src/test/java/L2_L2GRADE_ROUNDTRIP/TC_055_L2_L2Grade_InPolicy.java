...
public class TC_055_L2_L2Grade_InPolicy extends BaseClass{
	WebDriver driver;    
...
try {	    
      ...
      String origin = excelData.get("Origin");
        ...
        String returnDate=dates[14]; 
        String returnMonthYear=dates[15];
        ...
        tripgainhomepage.validatePolicyGrade("L2 - L2 Test Grade",Log,screenShots);
