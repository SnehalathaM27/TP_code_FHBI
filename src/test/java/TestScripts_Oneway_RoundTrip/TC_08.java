...
public class TC_08 extends BaseClass{
	...
	try {	    
        ...
        Thread.sleep(3000); 
      tripgainresultspage.clickAirlineCheckboxes(airlines1,airlines2);
         Thread.sleep(3000);
            tripgainresultspage.validateAirLinesList(Log, screenShots, airlines1,airlines2);
            
      /* airlineList=tripgainresultspage.getListOfAirlinesOnResultScreen();
        String airlineName= airlineList.get(0).toString();
        String airlineName1= airlineList.get(1).toString();

        tripgainresultspage.clickAirlineCheckboxes(airlineName,airlineName1);
        tripgainresultspage.validateAirLinesListDisplayedBasedOnUserSearch(Log, screenShots,airlineName,airlineName1);*/		
