...
public class Ph_1_Philips_Trips_HotelsFlights_Domestic_GradesndDates_Before7days extends BaseClass {
	WebDriver driver;    
...
//		List<String> servicesdetails = NewDesignTrips.selectServices("Hotel");
	   ...
	   String[] checkindateResultPage = NewDesignHotelsResultsPage.getCheckInDateTextFromResultPage();
		...
		NewDesign_HotelsBookingPage.enterEmailForHotels("traveller@tripgain.com");
