...
public class Ph_15_Philips_Trips_Flights_Oneway_International_Before15days extends BaseClass {
	WebDriver driver;    
...
try {	    
		...
		String EnteredtripName = NewDesignTrips.enterNameThisTrip("Flight_International_OOP1", Log);
