	...
	public class Ph_23_Philips_NF_Flights_International_RoundTrip_Individual_After15days extends BaseClass{
		WebDriver driver; 
	...
	try {	    
			...
			NewDesign_Trips NewDesignTrips = new NewDesign_Trips(driver);
		        ...
		        tripgain_HomePage.getAllPolicyTextsFromFlightCards();
	            Implementation_Corporate_Travellers_Page.validateFlightPolicyAgainstDaysForInternational(OnwardDateText, Log, screenShots);
		        tripgain_HomePage.clickViewFlightDetailsByIndex(2); 
		        String returnflightcardPolicyText = tripgain_HomePage.getFlightCardPolicyByIndex(2);
		        tripgain_HomePage.clickViewFareByIndex(selectFlightIndex);
