...
public class Ph_16_Philips_Trips_Flights_Oneway_International_After15days extends BaseClass {
	WebDriver driver;    
...
//after 15 days 
		...
		String EnteredtripName = NewDesignTrips.enterNameThisTrip("Flight_International_Inpolicy1", Log);
		String origindetails = NewDesignTrips.enterfrom("Dubai");
