...
public class Ph_4_Philips_Trips_Hotels_International_GradesndDates_After15days extends BaseClass {
	WebDriver driver;    
...
//after 15 days 
		String[] dates = GenerateDates.GenerateDatesToSelectFlights();
		 String fromDate=dates[18]; //16thday from today
         String fromMonthYear=dates[19];
		...
		Implementation_Corporate_TravellersPage Implementation_Corporate_Travellers_Page=new Implementation_Corporate_TravellersPage(driver);
		 ...
		 NewDesign_Emulate_Process.clcikOnAdmin();
	        ...
	        Implementation_Corporate_Travellers_Page.clickOnViewDetailBtnInCorpTravellers(searchvalue);
		...
		String EnteredtripName = NewDesignTrips.enterNameThisTrip("Hotel_International1", Log);
		...
		String[] TripDatesFromSearchPg = NewDesignTrips.getDatesFromTripDetailsPage();
		 ...
		 String locationToSearch = NewDesignTrips.enterLocationForHotelsOndetailsPg(origin);
	   ...
	   String[] checkindateResultPage = NewDesignHotelsResultsPage.getCheckInDateTextFromResultPage();
		...
		Implementation_Corporate_Travellers_Page.validateHotelDaysPolicyForInternational(checkindateResultPage, Log, screenShots);
