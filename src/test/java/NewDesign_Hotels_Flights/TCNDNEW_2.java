...
public class TCNDNEW_2 extends BaseClass{
	WebDriver driver;    
...
try {	    
	...
	//get all the hotel details from the selected hotel card
		String[] hotelDetails = NewDesignHotelsResultsPage.selectHotelAndGetDetails(hotelindex, Log);  //wrong xpath after this change 
