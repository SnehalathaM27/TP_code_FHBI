...
public class TC_32_VerifyOnwardsStopsFilter_2StopSelection extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
       ...
       //  tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BLR", "DFW", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy", 2);
         tripgainhomepage.searchFlightsOnHomePage(Log, screenShots, origin,destination,fromDate,fromMonthYear,returnDate,returnMonthYear,travelClass, adults);
           ...
           Thread.sleep(5000); 
           trs.verifyFlightsDetailsOnResultScreenForInternational(Log, screenShots);
        Thread.sleep(7000); 
      
        //Function to click on stops
        trs.roundTripClickOnWardStops(Stops);  
        Thread.sleep(2000);
        trs.validateFlightsStopsOnResultScreenforInternational(numberOfStops,Log, screenShots);
