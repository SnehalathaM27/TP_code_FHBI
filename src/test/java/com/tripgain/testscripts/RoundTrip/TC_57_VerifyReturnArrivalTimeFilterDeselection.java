...
public class TC_57_VerifyReturnArrivalTimeFilterDeselection extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        //Function to click on return arrival Time 
        trs.selectReturnArrivalTimeRoundtrip(times);
        Thread.sleep(3000);     

//trs.validateroundtripreturnArrivalTimeIsSelected(Log, screenShots, "00 - 06");
trs.validatereturnFlightsArrivalTimeroundtrip(flightStartHour, flightStartMinute, flightEndHour, flightEndMinute, Log, screenShots);
Thread.sleep(3000);     
