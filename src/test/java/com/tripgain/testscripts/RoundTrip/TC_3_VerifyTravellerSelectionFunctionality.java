...
public class TC_3_VerifyTravellerSelectionFunctionality extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        Thread.sleep(2000);
         ...
         //tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BBI", "HYD", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy", 4);
