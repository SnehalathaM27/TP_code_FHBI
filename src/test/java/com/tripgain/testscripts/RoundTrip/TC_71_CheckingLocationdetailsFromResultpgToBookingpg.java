...
public class TC_71_CheckingLocationdetailsFromResultpgToBookingpg extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
 ...
 Thread.sleep(15000); 
// trs.ValidateAirlineSelectionRoundtrip(Log, screenShots, "Air India");
 trs.roundTripClickOnWardStops("1");  

/*one method
 //Checking Location details From Resultpg To Bookingpg  */
 trs.validateLocationsFromResultToBookingPage(Log, screenShots, 2);
 ...
 //getting From div details
 trs.selectFlightInRoundTripFromLocation(1);
trs.validateFlightDetailsFromLocation(fromLocation,toLocation,journeyDateValue,stop,departTime,arrivalTime, Log, screenShots); trs.viewFlightDetailsClosePopup();
trs.viewFlightDetailsClosePopup();

 
 
 //return data from return div
trs.selectFlightInRoundTripToLocation(1);
//validation return flight details 
trs.validateFlightDetailsReturnLocation(fromLocation,toLocation,returnDateValue,toStop,todepartTime,toarrivalTime, Log, screenShots);
trs.viewFlightDetailsClosePopup();
