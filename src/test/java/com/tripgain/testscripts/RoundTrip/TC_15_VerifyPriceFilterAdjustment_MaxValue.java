...
public class TC_15_VerifyPriceFilterAdjustment_MaxValue extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
       ...
       //  tripgainhomepage.searchFlightsOnHomePageroundtrip(screenShots, "HYD", "BLR", "4", "June 2025", "5", "June 2025", "Premium Economy",3);
        // tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "HYD", "BLR", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy",3);
        ...
        double maximumValue=maxValue-3000;
