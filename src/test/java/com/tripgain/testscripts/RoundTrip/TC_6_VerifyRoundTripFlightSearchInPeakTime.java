...
public class TC_6_VerifyRoundTripFlightSearchInPeakTime extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
      ...
      //   tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BOM", "CCU", fromDate, fromMonthYear,returnDate, returnMonthYear, "Premium Economy",2 );
