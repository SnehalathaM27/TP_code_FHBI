...
public class TC_21_VerifyPriceTimeSorting extends BaseClass{
	WebDriver driver;    
...
//tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BLR", "HYD", "12", "June 2025", "14", "June 2025", "Premium Economy",2);
        ...
        //driver.quit();   
        Thread.sleep(40000);
        trs.PriceOrderCheckInAscending(Log, screenShots);
        trs.PriceOrderCheckInAscendingToDiv(Log, screenShots);
        trs.PriceDescendingFilter();
        Thread.sleep(30000);
        
        trs.PriceOrderCheckInDescending(Log, screenShots);
        Thread.sleep(10000);
        
        trs.PriceDescendingFilterToDiv();
        Thread.sleep(30000);
        
        trs.PriceOrderCheckInDescendingToDiv(Log, screenShots);
        Thread.sleep(10000);
