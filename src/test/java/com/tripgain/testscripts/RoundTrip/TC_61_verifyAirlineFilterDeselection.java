...
public class TC_61_verifyAirlineFilterDeselection extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
    ...
    Thread.sleep(4000);
      ...
      trs.selectAirLines(airlineToSelect);
      Thread.sleep(3000);
      trs.selectAirLines(airlineToSelect);
    	Log.ReportEvent("INFO","SUCCESSFULLY DESELECTED AIRLINES");
