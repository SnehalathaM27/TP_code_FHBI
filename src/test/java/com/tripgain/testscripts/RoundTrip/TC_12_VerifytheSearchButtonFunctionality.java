...
public class TC_12_VerifytheSearchButtonFunctionality extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
       ...
       //  tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "PNQ", "CJB", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy",1);
