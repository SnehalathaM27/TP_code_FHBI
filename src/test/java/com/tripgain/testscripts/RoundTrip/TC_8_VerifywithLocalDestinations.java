...
public class TC_8_VerifywithLocalDestinations extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        // tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "GRT", "DEL", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy",2 );
         ...
         tripgainresultspage.waitForProgressToComplete(driver);
