...
public class TC_68_SwapSearch extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
 ...
 //Function to validate swap
 trs.validateBeforeSwap(Log, screenShots, index1);
 Thread.sleep(3000);
 trs.swapRoundtrip();
 Thread.sleep(3000);
 trs.validateAfterSwap(Log, screenShots, index2);
