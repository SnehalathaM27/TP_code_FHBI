...
public class TC_11_VerifyWithInternationalAndLocalDestinations extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
      ...
      //   tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BQH", "CJB", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy",3);
