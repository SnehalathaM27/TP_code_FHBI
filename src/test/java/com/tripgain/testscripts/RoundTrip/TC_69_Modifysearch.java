...
public class TC_69_Modifysearch extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
 ...
 Thread.sleep(12000); 
 //validate Modify search
 tripgainhomepage.modifySearchTo(to);
 Thread.sleep(5000);
trs.validateRadioButtonIsChangedToOneWay(Log, screenShots);
