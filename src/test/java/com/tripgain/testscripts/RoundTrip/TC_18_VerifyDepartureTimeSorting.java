...
public class TC_18_VerifyDepartureTimeSorting extends BaseClass{
	WebDriver driver;    
...
//tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BLR", "HYD", "12", "June 2025", "14", "June 2025", "Premium Economy",2);
        ...
        Thread.sleep(7000); 
      /*  trs.DepartAscendingFilter();
        Thread.sleep(2000);
        trs.DepartDescendingFilter();
        Thread.sleep(2000);
       trs.checkresultsfordepature(Log, screenShots, "ascending");
        trs.checkresultsfordepature(Log, screenShots, "descending");*/
        
        Thread.sleep(40000);

        trs.DepartAscendingFilterForFromDiv();
        Thread.sleep(30000);

        trs.TimeOrderCheckInAscendingForDepartForFromDiv(Log,screenShots);
        Thread.sleep(10000);

        trs.DepartDescendingFilterForFromDiv();
        Thread.sleep(10000);
        
        trs.TimeOrderCheckInDescendingForDepartForFromDiv(Log,screenShots);
        Thread.sleep(10000);
        
        
        trs.DepartAscendingFilterForToDiv();
        Thread.sleep(30000);

        
        trs.TimeOrderCheckInAscendingForDepartForToDiv(Log,screenShots);
        Thread.sleep(10000);
        
        trs.DepartDescendingFilterForToDiv();
        Thread.sleep(10000);
        trs.TimeOrderCheckInDescendingForDepartForToDiv(Log,screenShots);
