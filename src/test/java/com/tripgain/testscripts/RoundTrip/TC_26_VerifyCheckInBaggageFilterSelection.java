...
public class TC_26_VerifyCheckInBaggageFilterSelection extends BaseClass{
	WebDriver driver;    
...
try {	    
        ...
        int VerifyFlightsDetailsOnResultScreenForLocal = Integer.parseInt(excelData.get("VerifyFlightsDetailsOnResultScreenForLocal"));
...
SiteChecker Site_Checker=new SiteChecker(driver);
      ...
      //   tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "HYD", "BLR", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy",2);
