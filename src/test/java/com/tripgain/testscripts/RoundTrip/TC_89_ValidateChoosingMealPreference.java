...
public class TC_89_ValidateChoosingMealPreference extends BaseClass{
	WebDriver driver;    
...
//method to search flight for RoundTrip
trs.selectAirLines("Indigo");
trs.selectFromAndToFlightsBasedOnIndex(1);
//tripgain_resultspage.selectFaretype("Normal");
trs.popupClose();
////tripgain_resultspage.selectFromAndToFlightsBasedOnIndex(1);
//Object[] Fromvalues=tripgain_resultspage.selectFlightInRoundTripFromLocation(2);
//tripgain_resultspage.viewFlightDetailsClosePopup();
Thread.sleep(3000);
...
double totalPrice  = tripgainresultspage.selectMealsOnwardOneWay(Log,screenShots,OnwardMealsSelectSplit);
// tripgain_resultspage.addTotalMealsPriceOneway(Log,screenShots);
double totalPricereturn  = tripgainresultspage.selectMealsReturn(Log,screenShots,ReturnMealsSelectSplit);
double totalCalculatedAmount = tripgainresultspage.addTotalMealsPrice(Log, screenShots,totalPrice,totalPricereturn);

Object totalvalue = tripgainresultspage.validateMealss(Log,screenShots,totalCalculatedAmount);
*/
