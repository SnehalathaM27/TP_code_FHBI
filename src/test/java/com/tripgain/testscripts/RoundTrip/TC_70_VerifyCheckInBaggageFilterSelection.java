...
public class TC_70_VerifyCheckInBaggageFilterSelection extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        //Function to validate Check In Baggage Functionality on Result Screen
  		...
  		Thread.sleep(4000);
  	  String flightname[]= new String[2];
      flightname[0]="Indigo";
           //flightname[1]="Akasha";
      String airlineName=trs.clickOnParticularAirline(flightname);
      Thread.sleep(3000);
      trs.selectFromAndToFlightsBasedOnIndex(1);
      trs.validateAllBaggageDetailsForAllAirline(airlineName,Log,screenShots);
      trs.closePopup();
      trs.selectToFlightsBasedOnIndex(1);
