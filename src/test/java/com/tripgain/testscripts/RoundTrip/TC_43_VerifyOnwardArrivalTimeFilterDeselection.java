...
public class TC_43_VerifyOnwardArrivalTimeFilterDeselection extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
      ...
      //   tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "HYD", "BLR", "12", "June 2025", "14", "June 2025", "Premium Economy",2);
        ...
        //Function to click on  arrival Time 
        trs.selectOnWardArrivalTimeroundtrip(times);
        //trs.validateroundtripOnwardArrivalTimeIsSelected(Log, screenShots,"00 - 06");
