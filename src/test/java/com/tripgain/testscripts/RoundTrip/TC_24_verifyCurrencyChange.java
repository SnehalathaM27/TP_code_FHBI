...
public class TC_24_verifyCurrencyChange extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
      ...
      //Function to validate Default Currency Code is Selected
        ...
        trs.defaultCurrencyValue(Log, screenShots);
  		...
  		tripgainresultspage.validateCurrencyRoundTrip(expectedCurrency, Log, screenShots);
    		driver.quit();
