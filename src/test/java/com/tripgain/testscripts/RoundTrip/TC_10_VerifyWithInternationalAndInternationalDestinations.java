...
public class TC_10_VerifyWithInternationalAndInternationalDestinations extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
      ...
      //   tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "LBG", "PWk", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy",1);
