...
public class TC_60_VerifyAirlineFilterSelection_MultipleAirline extends BaseClass{
	WebDriver driver;    
...
try {	    
        ...
        String airlineToSelect1 = excelData.get("AirlineToSelect1");
        
        String airlineToSelect2 = excelData.get("AirlineToSelect2");
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        Thread.sleep(2000);
         ...
         //tripgainhomepage.searchFlightsOnHomePageroundtrip(screenShots, "BLR", "BOM", "31", "May 2025", "1", "June 2025", "Premium Economy",2);
          // Thread.sleep(12000); 
          //.validateFlightsResultsForRoundTrip(Log, screenShots);
        Thread.sleep(5000); 
        ...
        List<String> AirlineName=trs.clickAirlineCheckboxRoundtripDomesticRoundtrip(Log, airlineToSelect1,airlineToSelect2);

        trs.validateDepartAirlinesDomesticroundtrip(Log,screenShots, AirlineName.get(0),AirlineName.get(1));
            Thread.sleep(2000);
          trs.validateReturnAirlinesDomesticroundtrip(Log, screenShots, AirlineName.get(0),AirlineName.get(1));
