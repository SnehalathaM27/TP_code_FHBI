...
public class TC_78_Verifyproceedtobuttonfuntionality extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
 ...
 Thread.sleep(15000); 
   ...
   //  trs.ValidateAirlineSelectionRoundtrip(Log, screenShots, airlineToSelect);
  //trs.selectFareBasedOnType(Log, screenShots, driver, "corporate");
  //trs.validateBookingAirlineMatchesSelected(Log, screenShots);
     trs.validateDepatureFaretypeToBookingPg(2, "Corporate", Log, screenShots);
