...
public class TC_72_VerifyingPriceFromResultpgToBookingpg extends BaseClass{
	WebDriver driver;    
...
try {	    
        ...
        int index1 = Integer.parseInt(excelData.get("Index1"));
        int index2 = Integer.parseInt(excelData.get("Index2"));
...
SiteChecker Site_Checker=new SiteChecker(driver);
 ...
 //Checking price details From Resultpg To Bookingpg
 trs.validatePricesFromResultToBooking(Log, screenShots, index1);
