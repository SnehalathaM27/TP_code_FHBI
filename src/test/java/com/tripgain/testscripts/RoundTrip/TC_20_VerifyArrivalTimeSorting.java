...
public class TC_20_VerifyArrivalTimeSorting extends BaseClass{
	WebDriver driver;    
...
//tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BLR", "HYD", "12", "June 2025", "14", "June 2025", "Premium Economy",2);
        ...
        Thread.sleep(7000); 
        trs.ArriveAscendingFilter();
        Thread.sleep(30000);

        trs.TimeOrderCheckInAscendingForArrival(Log, screenShots);
        Thread.sleep(10000);

        trs.ArriveDescendingFilter();
        Thread.sleep(10000);
        
        trs.TimeOrderCheckInDescendingForArrival(Log, screenShots);
        Thread.sleep(10000);
        
        trs.ArriveAscendingFilterToDiv();
        Thread.sleep(30000);

        trs.TimeOrderCheckInAscendingForArrivalToDiv(Log, screenShots);
        Thread.sleep(10000);

        trs.ArriveDescendingFilterToDiv();
        Thread.sleep(10000);
        
        trs.TimeOrderCheckInDescendingForArrivalToDiv(Log, screenShots);
        Thread.sleep(10000);
