...
public class TC_5_VerifyTravellerLimitMax9Adults extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        Thread.sleep(2000);
         ...
         //tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BLR", "DEL", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy", 9);
