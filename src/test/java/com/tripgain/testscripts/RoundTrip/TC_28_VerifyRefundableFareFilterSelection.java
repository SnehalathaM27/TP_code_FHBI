...
public class TC_28_VerifyRefundableFareFilterSelection extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        Thread.sleep(2000);
         ...
         //tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BLR", "HYD", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy",2);
       ...
       //Function for Refundable Fare Filter Selection
        ...
        Thread.sleep(3000);
        trs.validateRefundableFare(3, Log, screenShots);
