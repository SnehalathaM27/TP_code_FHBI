...
public class TC_33_VerifyOnwardsStopsFilterDeselection extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
      ...
      //   tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "HYD", "MAA", fromDate,fromMonthYear, returnDate, returnMonthYear, "Premium Economy", 2);
      ...
      Thread.sleep(3000);
        ...
        trs.roundTripClickOnWardStops(Stops);  
		Log.ReportEvent("PASS", "Stops filter deselection is successful");
