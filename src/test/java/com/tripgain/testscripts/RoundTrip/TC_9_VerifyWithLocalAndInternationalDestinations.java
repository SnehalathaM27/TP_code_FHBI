...
public class TC_9_VerifyWithLocalAndInternationalDestinations extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        Thread.sleep(2000);
         ...
         Thread.sleep(3000);
     //    tripgainhomepage.searchFlightsOnHomePage(Log, screenShots, "BOM", "NYC", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy",4 );
