...
public class TC_44_VerifyReturnStopsFilter_0StopsSelection extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
       ...
       trs.roundTripClickReturnStops(Stops);
        trs.validateFlightsreturnStopsOnResultScreen(numberOfStops,Log, screenShots);
