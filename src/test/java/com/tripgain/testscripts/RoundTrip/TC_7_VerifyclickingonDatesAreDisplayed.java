...
public class TC_7_VerifyclickingonDatesAreDisplayed extends BaseClass{
	WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
       ...
       //  tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BLR", "GOI", fromDate, fromMonthYear, returnDate, returnMonthYear, "Premium Economy", 3);
