...
public class TC_86_Validateblanktitle extends BaseClass{
	WebDriver driver;    
...
trs.clickOnTitleDropdown();
trs.selectTitleDropDownValueByText(Log, screenShots, driver, "Title");
trs.validateBookingpageTitle(Log, screenShots, driver);
