...
public class TC_19_VerifyDurationTimeSorting extends BaseClass{
	WebDriver driver;    
...
//tripgainhomepage.searchFlightsOnHomePageroundtrip(Log, screenShots, "BLR", "HYD", "12", "June 2025", "14", "June 2025", "Premium Economy",2);
        ...
        trs.DurationAscendingFilter();
        Thread.sleep(30000);

        trs.TimeOrderCheckInAscendingForDuration(Log,screenShots);
        Thread.sleep(10000);

        trs.DurationDescendingFilter();
        Thread.sleep(10000);
        
        
        trs.TimeOrderCheckInDescendingForDuration(Log,screenShots);
        Thread.sleep(10000);
        
        //Thread.sleep(40000);

        trs.DurationAscendingFilterForToDiv();
        Thread.sleep(30000);

        trs.TimeOrderCheckInAscendingForDurationForToDiv(Log,screenShots);
        Thread.sleep(10000);

        trs.DurationDescendingFilterForToDiv();
        Thread.sleep(10000);
        
        
        trs.TimeOrderCheckInDescendingForDurationForToDiv(Log,screenShots);
