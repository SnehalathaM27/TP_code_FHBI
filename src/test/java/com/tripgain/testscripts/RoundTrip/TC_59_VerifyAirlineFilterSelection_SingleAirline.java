...
public class TC_59_VerifyAirlineFilterSelection_SingleAirline extends BaseClass{
	WebDriver driver;    
...
Thread.sleep(2000);
        trs.validateReturnAirlinesDomesticroundtrip(3, Log, screenShots, AirlineName);
       
    //  trs.validateDepartAirlines(2, "Air India Express", Log, screenShots);
