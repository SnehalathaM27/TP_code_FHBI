...
public class TCE_6_VerifyExpenseByCreatingReport_MonthlyAllowanceReimbursementReport extends BaseClass{
	  WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        Thread.sleep(1000);
        Expenses_Module.ReportNameOnCreateReport("Monthly Allowance Reimbursement Report1", Log, screenShots);
        Thread.sleep(1000);
        Expenses_Module.getSelectYearTextFromMARR(Log, screenShots);
        Thread.sleep(1000);
        Expenses_Module.getSelectMonthTextFromMARR(Log, screenShots);
        Thread.sleep(1000);
        Expenses_Module.getSeletedtoDateTextFromMARR(Log, screenShots);
        Thread.sleep(1000);
