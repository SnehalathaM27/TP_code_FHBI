...
public class TCE_3_VerifyExpensesModule_Automate extends BaseClass{
	  WebDriver driver;    
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        Expenses_Module.clickOnSelectCategoryValuesByUserPassed(Log, screenShots, "Meals (Expenses on food  are recorded into this account.)");
        Thread.sleep(2000);
