...
public class TCE_2_VerifyExpensesModule_AddMileage extends BaseClass{
	  WebDriver driver;    
	...
	try {	    
     ...
     String currencyValue = excelData.get("CurrencyValue");
          ...
          String Comment = excelData.get("comment");
...
SiteChecker Site_Checker=new SiteChecker(driver);
        ...
        Expenses_Module.clickAddMileage();
        Expenses_Module.merchantName(merchantName, Log, screenShots);
        Thread.sleep(2000);
        Expenses_Module.enterfrom("Rajajinagar");
        Thread.sleep(2000);
       // Expenses_Module.addStop();
     //   Thread.sleep(2000);
    //    Expenses_Module.enterStop("Hennur");
     //   Thread.sleep(1000);
        Expenses_Module.enterTo("RR Nagar");
        Thread.sleep(10000);

        Expenses_Module.selectreportValues(Log, screenShots, "Test Expense (nontravel)");
        Thread.sleep(2000);
        Expenses_Module.selectDate("4", "July 2025");
        Thread.sleep(2000);
        Expenses_Module.selectVehicleType(Log, screenShots, "car");
        Thread.sleep(2000);
        ...
        Thread.sleep(2000);
        Expenses_Module.addRemarks(Comment, Log, screenShots);
        Thread.sleep(2000);
       
        Expenses_Module.getDistanceText(Log, screenShots);
        Thread.sleep(2000);
        Expenses_Module.getRateText(Log, screenShots);
        Thread.sleep(2000);
        Expenses_Module.getAmountTextFromAddMileage(Log, screenShots);
        Expenses_Module.uploadReceiptInAddMileage("C:\\Users\\LENOVO\\Downloads\\foodbill.png");
        Thread.sleep(2000);
        Expenses_Module.clickSaveButtonOnaddMileage();
